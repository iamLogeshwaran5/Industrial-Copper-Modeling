...
<div style='text-align:center'>
    <h1 style='color:#a30007;'>Industrial Copper Modeling Application</h1>
</div>
...
st.write(f'<h6 style="color:rgb(0, 150, 153,0.35);">App Created by TulasiNND</h6>', unsafe_allow_html=True)
